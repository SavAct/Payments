...
export interface SavactsavpayPayoffsigall {
	token_contract: string|number;
	token_symbol: string;
	recipient: string|number;
	memo: string;
...
export interface Savactsavpay extends Contract {
	...
	payoffnewacc(user_pub_key: string, user_name: string|number, sign_pub_key: string, sigtime: number, sig: string, options?: { from?: Account, auths?: ActorPermission[] }): Promise<any>;
	...
	payoffsigall(token_contract: string|number, token_symbol: string, recipient: string|number, memo: string, sign_pub_key: string, sigtime: number, sig: string, options?: { from?: Account, auths?: ActorPermission[] }): Promise<any>;
	...
	payoffnewacc_object_params(params: {user_pub_key: string, user_name: string|number, sign_pub_key: string, sigtime: number, sig: string}, options?: { from?: Account, auths?: ActorPermission[] }): Promise<any>;
	...
	payoffsigall_object_params(params: {token_contract: string|number, token_symbol: string, recipient: string|number, memo: string, sign_pub_key: string, sigtime: number, sig: string}, options?: { from?: Account, auths?: ActorPermission[] }): Promise<any>;
